...
var init_vue_esm = __esm({
  "node_modules/vue/dist/vue.esm.js"() {
    ...
    Dep.target = null;
    targetStack = [];
    VNode = function VNode2(tag, data, children, text2, elm, context, componentOptions, asyncFactory) {
      this.tag = tag;
      this.data = data;
      this.children = children;
      this.text = text2;
    ...
    nodeOps = /* @__PURE__ */ Object.freeze({
    ...
    CodegenState = function CodegenState2(options) {
      this.options = options;
    ...
    stripStringRE = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;
    range = 2;
    createCompiler = createCompilerCreator(function baseCompile(template2, options) {
    ...
    compile = ref$1.compile;
    compileToFunctions = ref$1.compileToFunctions;
...
// backend/dashboard/views/utils/custom-directives/vSafeHtml.js
var import_dompurify = __toESM(require_purify());
init_vue_esm();

// backend/dashboard/common/cdLodash.js
...
// backend/dashboard/common/translations.js
var import_dompurify2 = __toESM(require_purify());
init_vue_esm();

// backend/dashboard/common/stringTemplate.js
var nargs = /\{([0-9a-zA-Z_]+)\}/g;
function template(string, ...args) {
  const firstArg = args[0];
  const replacementsByKey = typeof firstArg === "object" && firstArg !== null ? firstArg : args;
  return string.replace(nargs, function replaceArg(match, capture, index2) {
...
//# sourceMappingURL=chunk-LWWMWDO5-cached.js.map
